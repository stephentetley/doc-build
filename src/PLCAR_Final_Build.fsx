...
let _filestoreRoot  = @"G:\work\Projects\plcar\final-docs\Input_Batch01"
let _outputRoot     = @"G:\work\Projects\plcar\final-docs\output"
let _templateRoot   = @"G:\work\Projects\plcar\final-docs\__Templates"
let _jsonRoot       = @"G:\work\Projects\plcar\final-docs\__Json"
...
Target.Create "Cover" (fun _ ->
    try
        let template = _templateRoot @@ "TEMPLATE PLC Cover.docx"
...
Target.Create "Final" (fun _ ->
    ...
    PdfConcat (fun p -> 
        { p with 
            OutputFile = makeSiteOutputName "%s S3821 PLC Asset Replacement Manual.pdf" })
        files
)
